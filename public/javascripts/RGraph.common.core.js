        ...
        */
        ...
        context.beginPath();
            ...
            for (var i=0; i<=5; ++i) {
                ...
                var original = ((max - min) * ((5-i) / 5)) + min;

                var text     = RGraph.number_format(obj, original, units_pre, units_post);
                ...
                RGraph.Text(context, font, size, x - (align == 'right' ? -5 : 5), gutterTop + ((height / 5)*i), text, 'center', align == 'right' ? 'left' : 'right');
            }
        context.stroke();
        ...
        */
        if (title) {
            context.beginPath();
                ...
                align == 'right' ? x + size + text_len : x - size - text_len,
